...
1. Give EvidenceIndex complete loaded source tables in original record order.
...
inputs, not inferred permissions. Cadence/absolute deltas without an authoritative
mapping remain issues. A new cash group needs a bound NewOccurrenceTarget, host
